export default {
  ...
  redeemCodeOnlyTag: "Redeem only",
  redeemCodeOnlyNotice: "The following nodes use redeem-code-only claiming. Enter the code here directly; selecting a node first is no longer required.",
  redeemCodeOnlySelectedTitle: "{provider} uses redeem-code-only claiming",
  redeemCodeOnlySelectedDescription: "The per-node redemption area is disabled. Please use the persistent redeem-code area above.",
  useGlobalRedeemArea: "Use the persistent redeem-code area above",
