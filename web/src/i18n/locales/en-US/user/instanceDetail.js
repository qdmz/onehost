export default {
  ...
  snapshotQuota: "Snapshot quota: used {used} / allowed {max}",
  ...
  webVNC: "Web VNC",
  renew: "Renew",
  renewMonths: "Renew period (months)",
  renewOrderCreated: "Renewal order created (No. {id}), please go to Orders to pay",
  renewFailed: "Failed to create renewal order",
