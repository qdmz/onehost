...
func GetProviderDescription(providerType string) map[string]interface{} {
	descriptions := map[string]map[string]interface{}{
		...
		"qemu": {
			"name":        "QEMU/KVM",
			"description": "QEMU/KVM虚拟机端口映射，使用iptables NAT规则进行端口转发",
			"methods":     []string{"iptables-nat"},
			"protocols":   []string{"tcp", "udp"},
		...
		"kubevirt": {
			"name":        "KubeVirt",
			"description": "KubeVirt虚拟机端口映射，使用iptables NAT规则进行端口转发",
			"methods":     []string{"iptables-nat"},
			"protocols":   []string{"tcp", "udp"},
			"features":    []string{"vm-specific", "host-level"},
		},
		...
		"virtualbox": {
			"name":        "VirtualBox",
			"description": "VirtualBox本地虚拟机端口映射，使用iptables NAT规则进行端口转发",
			"methods":     []string{"iptables-nat"},
			"protocols":   []string{"tcp", "udp"},
			"features":    []string{"vm-specific", "host-level"},
		},
		"multipass": {
			"name":        "Multipass",
			"description": "Multipass本地虚拟机端口映射，使用iptables NAT规则进行端口转发",
			"methods":     []string{"iptables-nat"},
			"protocols":   []string{"tcp", "udp"},
			"features":    []string{"vm-specific", "host-level"},
		},
		"vagrant": {
			"name":        "Vagrant",
			"description": "Vagrant本地虚拟机端口映射，使用iptables NAT规则进行端口转发",
			"methods":     []string{"iptables-nat"},
			"protocols":   []string{"tcp", "udp"},
			"features":    []string{"vm-specific", "host-level"},
		},
